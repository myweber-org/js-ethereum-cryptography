...
function savePreferencesToStorage(manager: UserPreferencesManager): void {
  localStorage.setItem('userPreferences', manager.exportAsJSON());
}

export { UserPreferencesManager, createPreferencesManager, savePreferencesToStorage, type UserPreferences };interface UserPreferences {
  theme: 'light' | 'dark' | 'auto';
  language: string;
  notificationsEnabled: boolean;
  fontSize: number;
