...
class UserPreferencesManager {
  ...
  updatePreferences(updates: Partial<UserPreferences>): void {
    try {
      ...
      throw new Error(`Invalid preferences: ${error instanceof Error ? error.message : 'Unknown error'}`);
    }
  }
...
class UserPreferencesManager {
  ...
  updatePreferences(updates: Partial<UserPreferences>): void {
    this.preferences = {
      ...this.preferences,
      ...this.validatePartialPreferences(updates)
    };
    this.savePreferences();
  }

  private validatePartialPreferences(updates: Partial<UserPreferences>): Partial<UserPreferences> {
