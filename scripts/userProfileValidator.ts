...
export { UserProfile, UserProfileValidator, ValidationResult };import { z } from 'zod';
...
function createDefaultProfile(username: string, email: string, age: number): UserProfile {
  const profileData = {
    username,
    email,
    age,
