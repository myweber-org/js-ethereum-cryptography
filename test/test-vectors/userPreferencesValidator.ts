...
export { validateUserPreferences, savePreferences, PreferenceValidationError };
...
export function createDefaultPreferences(): UserPreferences {
  return PreferencesValidator.sanitize({});
}import { z } from 'zod';
...
function testValidation() {
    const testPreferences: UserPreferences[] = [
        ...
        { theme: 'midnight', notifications: 'yes', language: 'zh', fontSize: 200 },
        { theme: 'auto', notifications: false, language: 'fr', fontSize: 12 }
    ];
