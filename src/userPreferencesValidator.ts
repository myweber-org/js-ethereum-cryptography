...
export function sanitizePreferences(prefs: Partial<UserPreferences>): Partial<UserPreferences> {
  ...
  if (prefs.notifications) {
    sanitized.notifications = {
      email: typeof prefs.notifications.email === 'boolean' ? prefs.notifications.email : true,
      push: typeof prefs.notifications.push === 'boolean' ? prefs.notifications.push : false,
      frequency: ['instant', 'daily', 'weekly'].includes(prefs.notifications.frequency || '')
        ? prefs.notifications.frequency
        : 'daily'
    };
  }
