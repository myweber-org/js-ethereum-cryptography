...
class UserPreferencesManager {
  ...
  private validateAndFixPreferences(): void {
    ...
    if (!VALID_ITEMS_PER_PAGE.includes(this.preferences.itemsPerPage)) {
  ...
  updatePreferences(updates: Partial<UserPreferences>): boolean {
    ...
    if (updates.itemsPerPage && !VALID_ITEMS_PER_PAGE.includes(updates.itemsPerPage)) {
      return false;
    }
...
export { UserPreferencesManager, DEFAULT_PREFERENCES, VALID_LANGUAGES, VALID_ITEMS_PER_PAGE };