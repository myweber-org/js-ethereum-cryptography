...
class UserProfileManager {
  ...
  searchProfilesByUsername(usernameQuery: string): UserProfile[] {
  ...
  toggleNotificationPreference(id: string): boolean {
...
const updateResult = profileManager.updateProfile('user-123', {
  age: 31,
  lastLogin: new Date()
});
