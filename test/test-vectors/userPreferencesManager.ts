...
const prefManager = new UserPreferencesManager(defaultPrefs);

prefManager.updatePreferences({ theme: 'dark', fontSize: 18 });
console.log(prefManager.getPreferences());interface UserPreferences {
